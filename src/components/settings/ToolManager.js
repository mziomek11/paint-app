...
const DrawManager = () => {
  ...
  const handleToolClick = (e, newTool) => {
    setTool(newTool);
    select.current.childNodes.forEach(node =>
    ...
    <div className="tool-maganer">
      <div className="tool-select" ref={select}>
        ...
        <div
          ...
          onClick={e => handleToolClick(e, <Rubber />)}
        >
        ...
        <div
          className="tool-option"
          onClick={e => handleToolClick(e, <Ellipse />)}
        >
          <i className="far fa-circle"></i>
        </div>
        <div
          className="tool-option"
          onClick={e => handleToolClick(e, <Rect />)}
        >
          <div className="rect"></div>
        </div>
        <div
          className="tool-option"
          onClick={e => handleToolClick(e, <Fill />)}
        >
          <i className="fas fa-fill-drip"></i>
        </div>
        <div
          className="tool-option"
          onClick={e => handleToolClick(e, <Picker />)}
        >
